(() => {
    ...
    const burger_isMobile = {
        ...
        any: function() {
            return burger_isMobile.Android() || burger_isMobile.BlackBerry() || burger_isMobile.iOS() || burger_isMobile.Opera() || burger_isMobile.Windows();
        }
    };
    if (burger_isMobile.any()) {
